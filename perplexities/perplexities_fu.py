...
if __name__ == "__main__":
    ...
    test_files = sorted(glob(
        f"{MULTILINGUAL_DATA_PATH}/multilingual_data_perturbed/{args.test_perturbation_type}_{lang_test}/test_affected/*"))
    ...
    vs = str(vs)
    file = directory + \
        f"/{args.paren_model}_seed{args.random_seed}_test_{args.test_perturbation_type}_{lang_test}_{vs}.csv"
